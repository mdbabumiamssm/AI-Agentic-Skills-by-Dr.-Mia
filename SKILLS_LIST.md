...
**Core capabilities:**
- 10x Visium and Xenium data processing
- Spatial variable gene identification (Moran's I)
- Cell type deconvolution (Cell2Location)
- Spatial neighborhood analysis (Squidpy)
- Interactive tissue plotting
...
**Core capabilities:**
- Whole Slide Image (WSI) preprocessing (tiling, normalization)
- Nuclei segmentation (StarDist, HoverNet)
- Patch-level feature extraction (ResNet, ViT)
- Slide-level heatmap generation
...
| Spatial Tumor Microenvironment | spatial-transcriptomics + pathology-ai |
...
*Managed by MD BABU MIA, PhD - Mount Sinai*
*February 2026*
