...
9. **Precision Grounding workflow** - Use Precision Grounding as the named workflow for trustworthy genetic variant summarization: retrieve evidence from databases and literature, link each generated claim to provenance, reconcile conflicts across ClinVar, gnomAD, and literature, run hallucination checks against retrieved evidence, and produce report-ready variant summaries.
