...
5.  **Precision-grounded Variant Summarization**: Requires evidence-backed retrieval from ClinVar, gnomAD, dbSNP, disease resources, ACMG/AMP evidence codes, and literature; separates retrieved evidence from generated synthesis and reports citations, confidence, conflicts, review status, ACMG-relevant fields, and explicit uncertainty rather than free-form LLM interpretation.
