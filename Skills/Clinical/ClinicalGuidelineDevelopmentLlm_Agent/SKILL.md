...
10. **Specialty-guideline concordance testing**: Compare LLM recommendations criterion by criterion against applicable professional-society recommendations, classifying discrepancies as omissions, contradictions, outdated advice, or potential harm.
11. **Conflict and dissent handling**: Track conflicts of interest, competing interpretations, panel disagreements, and the final governance disposition.
12. **Safety and scope control**: Flag unsupported claims, outdated evidence, population mismatches, off-label implications, and recommendations requiring human adjudication.
13. **Audit-ready output**: Produce a concise record of prompts, evidence inputs, LLM-generated drafts, human edits, decisions, and remaining uncertainties.
