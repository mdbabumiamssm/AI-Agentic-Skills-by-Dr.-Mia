...
4.  **Dermatology and Dermoscopy Use Case**: For suspected basal cell carcinoma and common mimickers, check clinical skin photographs and dermoscopic image quality for focus, lighting, scale, lesion completeness, artifacts, and occlusion before analysis; capture lesion context from available clinical images, dermoscopic views, and clinical notes; include basal cell carcinoma mimic differential checks; calibrate confidence to image quality and clinical context; use explicit uncertainty language; frame outputs as triage support rather than a definitive diagnosis; do not treat chatbot image output as diagnostic without task-specific clinical validation; and require dermatologist review before clinical use or any clinical action.
