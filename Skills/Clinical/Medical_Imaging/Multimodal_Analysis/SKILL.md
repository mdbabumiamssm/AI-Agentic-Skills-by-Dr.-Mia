...
4.  **Dermatology and Dermoscopy Safeguards**: For suspected basal cell carcinoma and common mimickers, check clinical and dermoscopic image quality for focus, lighting, scale, lesion completeness, artifacts, and occlusion before analysis; capture lesion context from available clinical images, dermoscopic views, and clinical notes; use explicit uncertainty language; frame outputs as triage support with a lesion-level differential diagnosis rather than a definitive diagnosis; and require dermatologist confirmation before any clinical action.
