...
11. **Fine-Grained Medical Q&A Dataset Evaluation**: Reviews domain-specific medical Q&A datasets before trusting medical LLM outputs by designing rubrics for correctness, omissions, unsafe advice, hallucinated citations, and dataset coverage.
