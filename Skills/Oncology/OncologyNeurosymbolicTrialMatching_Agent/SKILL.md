...
9. **Prospective 3,804-patient evaluation grounding:** Incorporate the 2026 PubMed-indexed prospective evaluation in 3,804 oncology patients as support for neuro-symbolic multi-agent oncology trial matching grounded in an oncology-specific knowledge graph, with criterion-level reasoning, explicit conflict resolution, clinician-auditable outputs, and clinician review; do not infer unstated benchmark or performance values.
