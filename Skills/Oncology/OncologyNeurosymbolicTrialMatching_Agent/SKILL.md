...
25. **Prospective benchmark pattern:** Treat the 3,804-patient oncology trial-matching evaluation as a benchmark pattern for neuro-symbolic multi-agent matching that combines KG-backed eligibility parsing, criterion-level evidence, conflict resolution, clinician-auditable decisions, and prospective performance reporting limited to source-supported or locally measured results.
26. **Key prospective evidence source:** Incorporate the 2026 PubMed-indexed prospective evaluation in 3,804 oncology patients as evidence for oncology knowledge graph grounding, specialist-agent trial matching roles, criterion-level eligibility reasoning, explicit conflict handling, and clinician-auditable outputs without adding unsupported benchmark claims.
27. **Prospective validation evidence:** Use the reported 2026 prospective evaluation of 3,804 oncology patients as validation evidence for neuro-symbolic multi-agent trial matching grounded in an oncology-specific knowledge graph, with criterion-level symbolic eligibility checks, explicit conflict resolution, and clinician-auditable output; report only source-supported or locally measured performance claims.
28. **Auditable rationale construction:** When applying the 3,804-patient prospective evaluation pattern, decompose each match rationale into oncology knowledge-graph retrieval, symbolic criterion adjudication, specialist-agent findings, conflict disposition, and clinician-review evidence so every recommendation remains auditable without adding unstated performance claims.
29. **Benchmark case for prospective matching:** Treat the prospective 3,804-patient neuro-symbolic multi-agent oncology trial-matching evaluation as a benchmark case for knowledge-graph-grounded retrieval, criterion-level reasoning, explicit conflict resolution, clinician-auditable evidence, and prospective workflow metrics; report only the cohort size and other metrics that are source-supported or locally measured.
