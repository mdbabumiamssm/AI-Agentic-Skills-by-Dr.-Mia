...
9. **ASCO GI cancer management coverage** - Use the 2026 ASCO Educational Book review on AI for GI cancer management as high-level evidence context when scoping endoscopy, imaging, pathology, molecular profiling, treatment planning, clinical trial support, surveillance, clinician governance, and human oversight workflows; keep outputs framed as clinician-governed decision support and explicitly surface evidence, validation, bias, implementation, generalizability limitations, and limits on autonomous recommendations.
